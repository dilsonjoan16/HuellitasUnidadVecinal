          ...
          <div class="row">
            <div class="col-6 mx-auto my-4">
              <div class="list-group hover-zoom mx-auto my-auto">
                <h1
                  class="list-group-item text-secondary text-justify mx-auto my-1"
                  id="titulo"
                >
                  Capa de Transporte
                </h1>
                <span
                  class="list-group-item mt-3 text-secondary text-justify"
                  id="titulo"
                >
                  <i>
                    Los protocolos de las capas anteriores permiten enviar
                    información de un equipo a otro. La capa de transporte
                ...
                >
                  <button
                    class="btn btn-outline-secondary my-2 my-sm-0 mx-auto"
                    type="submit"
                    to="/"
                  >
                    Vamos a ello!
...
/*ESTILOS DEL NAVBAR*/
.header {
  background: url(../assets/fondo9.png) no-repeat center;
