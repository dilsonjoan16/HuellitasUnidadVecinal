            ...
            <div class="dk-footer-box-info col-md-12 col-lg-12 col-sm-12 mt-5" id="exposicion">
              ...
              <div class="footer-social-link">
                ...
                <ul>
                  <li>
                    <a
                      href="https://www.facebook.com/Prensa-Unefa-Tachira-1074685815875284/"
                    >
                      <i class="fa fa-facebook"></i>
                    </a>
                  </li>
                  <li>
                    <a href="https://twitter.com/decanatotunefa?lang=es">
                  ...
                  <li>
                    <a
                      href="https://instagram.com/unefatachiraoficial?igshid=pnpg89fefu22"
                    >
              ...
              <div class="col-md-12 col-lg-6">
                <div class="footer-widget">
                  ...
                  <p class="text-white">
                    ...
                    Proporciona tu email si quieres formar parte del reporte
                    semanal!
                  </p>
                  <form action="#">
                    <div class="form-row">
                      <div class="col dk-footer-form">
                        <input
                          ...
                          placeholder="Tu email aqui campeon(a)"
                        />
                        <button type="submit" v-on:click="alerta()">
...
export default {
  ...
  methods: {
    alerta() {
      Swal.fire("Recibido!", "Tu correo fue enviado con exito!", "success");
    },
  },
};
</script>
