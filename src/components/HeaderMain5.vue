              ...
              <div class="list-group hover-zoom mx-auto my-auto">
                ...
                >
                  <i>
                    ...
                    proporcionan la interfaz con el sistema operativo para que
                    el usuario pueda interactuar acorde con la máquina ya sea
...
/*ESTILOS DEL NAVBAR*/
.header {
  background: url(../assets/fondo11.webp) no-repeat center;
